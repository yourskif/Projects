...
namespace UnivercityDepartment.Controllers
{
    public class FacultiesController : Controller
    {
        ...
        {
            _context = context; // ≤н≥ц≥ал≥зац≥€ контексту бази даних
        }
        ...
        public async Task<IActionResult> Index()
        {
            var faculties = await _context.Faculties
                .Include(f => f.Departments) // ¬ключаЇмо в≥дд≥ли факультет≥в
                .ToListAsync();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var faculty = await _context.Faculties
                .Include(f => f.Departments) // ¬ключаЇмо в≥дд≥ли
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            // ќтримуЇмо список в≥дд≥л≥в дл€ випадаючого списку
